...
{
    public class GetOrdersSpViewModel : GetOrdersViewModelBase
    {
        public GetOrdersSpViewModel(MainWindowViewModel mainWindowViewModel) : base(mainWindowViewModel)
        {
        }
